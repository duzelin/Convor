...
output   ap_idle;
output   ap_ready;
input  [31:0] In_pre_V319_dout;
input   In_pre_V319_empty_n;
output   In_pre_V319_read;
...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln153_fu_167_p2 == 1'd0) & (1'b0 == In_pre_V319_empty_n)) & (icmp_ln153_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln153_fu_167_p2 == 1'd0) & (1'b0 == In_pre_V319_empty_n)) & (icmp_ln153_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((icmp_ln153_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        ...
        In_pre_V319_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((icmp_ln153_fu_167_p2 == 1'd0) & (1'b0 == In_pre_V319_empty_n)) & (icmp_ln153_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        In_pre_V319_read = 1'b1;
    end else begin
        In_pre_V319_read = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if ((~((icmp_ln153_fu_167_p2 == 1'd0) & (1'b0 == In_pre_V319_empty_n)) & (icmp_ln153_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if ((~((icmp_ln153_fu_167_p2 == 1'd0) & (1'b0 == In_pre_V319_empty_n)) & (icmp_ln153_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end
...
always @ (*) begin
    ap_block_state5 = ((icmp_ln153_fu_167_p2 == 1'd0) & (1'b0 == In_pre_V319_empty_n));
end
