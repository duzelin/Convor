...
reg   [0:0] icmp_ln274_reg_148;
reg   [30:0] p_0_rec_reg_93;
reg   [30:0] p_0_rec_reg_93_pp0_iter1_reg;
wire    ap_block_state8_pp0_stage0_iter0;
reg    ap_block_state9_pp0_stage0_iter1;
wire    ap_block_state10_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln274_fu_120_p2;
reg   [0:0] icmp_ln274_reg_148_pp0_iter1_reg;
wire   [30:0] i_fu_125_p2;
reg   [30:0] i_reg_152;
reg    ap_enable_reg_pp0_iter0;
reg   [31:0] W_ddr_addr_read_reg_157;
wire    ap_CS_fsm_state7;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state8;
reg    ap_enable_reg_pp0_iter2;
reg   [30:0] ap_phi_mux_p_0_rec_phi_fu_97_p4;
wire   [63:0] p_0_rec_cast_fu_131_p1;
wire   [63:0] zext_ln273_fu_105_p1;
wire   [31:0] i_0_cast_fu_116_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln274_reg_148 == 1'd1))) begin
        p_0_rec_reg_93 <= i_reg_152;
    end else if ((1'b1 == ap_CS_fsm_state7)) begin
        p_0_rec_reg_93 <= 31'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln274_reg_148 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln274_reg_148 == 1'd1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln274_reg_148_pp0_iter1_reg == 1'd1))) begin
        W_we0 = 1'b1;
    end else begin
        W_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((icmp_ln274_fu_120_p2 == 1'd0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln274_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((icmp_ln274_fu_120_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign W_address0 = p_0_rec_cast_fu_131_p1;

assign W_d0 = W_ddr_addr_read_reg_157;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_W_ddr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln274_reg_148 == 1'd1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_W_ddr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln274_reg_148 == 1'd1));
end
...
always @ (*) begin
    ap_block_state9_pp0_stage0_iter1 = ((m_axi_W_ddr_RVALID == 1'b0) & (icmp_ln274_reg_148 == 1'd1));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign i_0_cast_fu_116_p1 = ap_phi_mux_p_0_rec_phi_fu_97_p4;

assign i_fu_125_p2 = (ap_phi_mux_p_0_rec_phi_fu_97_p4 + 31'd1);

assign icmp_ln274_fu_120_p2 = (($signed(i_0_cast_fu_116_p1) < $signed(length_r)) ? 1'b1 : 1'b0);

assign m_axi_W_ddr_ARADDR = zext_ln273_fu_105_p1;
...
assign p_0_rec_cast_fu_131_p1 = p_0_rec_reg_93_pp0_iter1_reg;

assign zext_ln273_fu_105_p1 = W_ddr_offset;
