...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln170_fu_167_p2 == 1'd0) & (1'b0 == W_next_V418_empty_n)) & (icmp_ln170_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln170_fu_167_p2 == 1'd0) & (1'b0 == W_next_V418_empty_n)) & (icmp_ln170_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if ((~((icmp_ln170_fu_167_p2 == 1'd0) & (1'b0 == W_next_V418_empty_n)) & (icmp_ln170_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if ((~((icmp_ln170_fu_167_p2 == 1'd0) & (1'b0 == W_next_V418_empty_n)) & (icmp_ln170_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end
...
always @ (*) begin
    ap_block_state5 = ((icmp_ln170_fu_167_p2 == 1'd0) & (1'b0 == W_next_V418_empty_n));
end
