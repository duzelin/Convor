...
set C_modelName {Drain_In39}
set C_modelType { void 0 }
set C_modelArgList {
	{ In_pre_V214 float 32 regular {fifo 0 volatile }  }
	{ p_c_s int 32 regular {fifo 0}  }
	{ p_chin_s int 32 regular {fifo 0}  }
	{ p_k_s int 32 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "In_pre_V214", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ In_pre_V214_dout sc_in sc_lv 32 signal 0 } 
	{ In_pre_V214_empty_n sc_in sc_logic 1 signal 0 } 
	{ In_pre_V214_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "In_pre_V214_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "In_pre_V214", "role": "dout" }} , 
 	{ "name": "In_pre_V214_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "In_pre_V214", "role": "empty_n" }} , 
 	{ "name": "In_pre_V214_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "In_pre_V214", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "In_pre_V214", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	In_pre_V214 { ap_fifo {  { In_pre_V214_dout fifo_data 0 32 }  { In_pre_V214_empty_n fifo_status 0 1 }  { In_pre_V214_read fifo_update 1 1 } } }
