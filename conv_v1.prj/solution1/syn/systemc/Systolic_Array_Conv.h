...
struct Systolic_Array_Conv : public sc_module {
    ...
    Systolic_Array_Cotde* Out_buffer_U;
    ...
    sc_signal< sc_lv<32> > Out_buffer_d0;
    ...
    sc_signal< sc_logic > grp_Write_C_buf_fu_296_Out_buf_we0;
    sc_signal< sc_lv<32> > grp_Write_C_buf_fu_296_Out_buf_d0;
