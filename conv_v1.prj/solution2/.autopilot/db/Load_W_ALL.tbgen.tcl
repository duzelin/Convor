...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7", "Max" : "1805"}
	, {"Name" : "Interval", "Min" : "7", "Max" : "1805"}
]}
...
set Spec2ImplPortList { 
	...
	W_buf { ap_memory {  { W_buf_address0 mem_address 1 9 }  { W_buf_ce0 mem_ce 1 1 }  { W_buf_q0 mem_dout 0 32 }  { W_buf_address1 MemPortADDR2 1 9 }  { W_buf_ce1 MemPortCE2 1 1 }  { W_buf_q1 MemPortDOUT2 0 32 } } }
