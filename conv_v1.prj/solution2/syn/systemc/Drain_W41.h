...
#ifndef _Drain_W41_HH_
#define _Drain_W41_HH_
...
struct Drain_W41 : public sc_module {
    ...
    sc_in< sc_lv<32> > W_next_V4_dout;
    sc_in< sc_logic > W_next_V4_empty_n;
    sc_out< sc_logic > W_next_V4_read;
    ...
    // Module declarations
    Drain_W41(sc_module_name name);
    SC_HAS_PROCESS(Drain_W41);
    ...
    sc_signal< sc_logic > W_next_V4_blk_n;
    ...
    void thread_W_next_V4_blk_n();
    void thread_W_next_V4_read();
