...
#ifndef _Drain_In38_HH_
#define _Drain_In38_HH_
...
struct Drain_In38 : public sc_module {
    ...
    sc_in< sc_lv<32> > In_pre_V19_dout;
    sc_in< sc_logic > In_pre_V19_empty_n;
    sc_out< sc_logic > In_pre_V19_read;
    ...
    // Module declarations
    Drain_In38(sc_module_name name);
    SC_HAS_PROCESS(Drain_In38);
    ...
    sc_signal< sc_logic > In_pre_V19_blk_n;
    ...
    void thread_In_pre_V19_blk_n();
    void thread_In_pre_V19_read();
