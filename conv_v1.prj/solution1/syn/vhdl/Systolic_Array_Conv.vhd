...
architecture behav of Systolic_Array_Conv is 
    ...
    "Systolic_Array_Conv,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=152,HLS_SYN_FF=23952,HLS_SYN_LUT=36122,HLS_VERSION=2020_1}";
    ...
    signal Out_buffer_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_Write_C_buf_fu_296_Out_buf_we0 : STD_LOGIC;
    signal grp_Write_C_buf_fu_296_Out_buf_d0 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    Out_buffer_U : component Systolic_Array_Cotde
    generic map (
        DataWidth => 32,
        AddressRange => 500,
        AddressWidth => 9)
    ...
    port map (
        ...
        Out_buf_we0 => grp_Write_C_buf_fu_296_Out_buf_we0,
        Out_buf_d0 => grp_Write_C_buf_fu_296_Out_buf_d0,
    ...
    Out_buffer_d0_assign_proc : process(grp_PE_array_fu_246_Out_buf_d0, grp_Write_C_buf_fu_296_Out_buf_d0, ap_CS_fsm_state11, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            Out_buffer_d0 <= grp_Write_C_buf_fu_296_Out_buf_d0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            Out_buffer_d0 <= grp_PE_array_fu_246_Out_buf_d0;
        else 
            Out_buffer_d0 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;


    Out_buffer_we0_assign_proc : process(grp_PE_array_fu_246_Out_buf_we0, grp_Write_C_buf_fu_296_Out_buf_we0, ap_CS_fsm_state11, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            Out_buffer_we0 <= grp_Write_C_buf_fu_296_Out_buf_we0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
