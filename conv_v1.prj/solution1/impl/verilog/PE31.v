...
output   ap_idle;
output   ap_ready;
input  [31:0] W_inter_2_2_dout;
input   W_inter_2_2_empty_n;
output   W_inter_2_2_read;
input  [31:0] In_inter_2_2_dout;
input   In_inter_2_2_empty_n;
output   In_inter_2_2_read;
output  [31:0] W_inter_3_2_din;
input   W_inter_3_2_full_n;
output   W_inter_3_2_write;
output  [31:0] In_inter_2_3_din;
input   In_inter_2_3_full_n;
output   In_inter_2_3_write;
...
output  [31:0] O_inter_2_2_din;
input   O_inter_2_2_full_n;
output   O_inter_2_2_write;
...
reg ap_idle;
reg ap_ready;
reg W_inter_2_2_read;
reg In_inter_2_2_read;
reg W_inter_3_2_write;
reg In_inter_2_3_write;
reg add_ln207_4_loc_read;
reg add_ln207_1_loc_read;
reg O_inter_2_2_write;
reg p_c_s_read;
reg p_chin_s_read;
reg p_chout_s_read;
reg p_k_s_read;
...
reg   [31:0] kc_reg_428;
reg    ap_block_state5;
reg   [31:0] tmp_32_reg_433;
reg   [31:0] tmp_31_reg_438;
wire   [31:0] grp_fu_295_p2;
reg   [31:0] tmp_4_i_i_i_reg_443;
wire    ap_CS_fsm_state7;
wire   [31:0] O_temp_6_fu_373_p3;
...
wire   [0:0] icmp_ln130_6_fu_305_p2;
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == O_inter_2_2_full_n) & (icmp_ln122_fu_336_p2 == 1'd0)) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln122_fu_336_p2 == 1'd0))) begin
        col_0_i_i_i_reg_209 <= col_reg_404;
    end else if ((~((p_k_out_full_n == 1'b0) | (p_chout_out_full_n == 1'b0) | (p_chin_out_full_n == 1'b0) | (p_c_out_full_n == 1'b0) | (1'b0 == add_ln207_1_loc_out_full_n) | (p_r_s_empty_n == 1'b0) | (p_k_s_empty_n == 1'b0) | (p_chout_s_empty_n == 1'b0) | (p_chin_s_empty_n == 1'b0) | (p_c_s_empty_n == 1'b0) | (1'b0 == add_ln207_1_loc_empty_n) | (1'b0 == add_ln207_4_loc_empty_n) | (ap_start == 1'b0) | (p_r_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd1))) begin
        kr_0_i_i_i_reg_256 <= kr_reg_420;
    end else if ((~((1'b0 == O_inter_2_2_full_n) & (icmp_ln122_fu_336_p2 == 1'd0)) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln122_fu_336_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((p_k_out_full_n == 1'b0) | (p_chout_out_full_n == 1'b0) | (p_chin_out_full_n == 1'b0) | (p_c_out_full_n == 1'b0) | (1'b0 == add_ln207_1_loc_out_full_n) | (p_r_s_empty_n == 1'b0) | (p_k_s_empty_n == 1'b0) | (p_chout_s_empty_n == 1'b0) | (p_chin_s_empty_n == 1'b0) | (p_c_s_empty_n == 1'b0) | (1'b0 == add_ln207_1_loc_empty_n) | (1'b0 == add_ln207_4_loc_empty_n) | (ap_start == 1'b0) | (p_r_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == O_inter_2_2_full_n) & (icmp_ln122_fu_336_p2 == 1'd0)) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd0))) begin
        In_inter_2_2_read = 1'b1;
    end else begin
        In_inter_2_2_read = 1'b0;
    end
end
...
always @ (*) begin
    if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd0))) begin
        In_inter_2_3_write = 1'b1;
    end else begin
        In_inter_2_3_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln122_fu_336_p2 == 1'd0))) begin
        ...
        O_inter_2_2_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((1'b0 == O_inter_2_2_full_n) & (icmp_ln122_fu_336_p2 == 1'd0)) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln122_fu_336_p2 == 1'd0))) begin
        O_inter_2_2_write = 1'b1;
    end else begin
        O_inter_2_2_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd0))) begin
        W_inter_2_2_read = 1'b1;
    end else begin
        W_inter_2_2_read = 1'b0;
    end
end
...
always @ (*) begin
    if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd0))) begin
        W_inter_3_2_write = 1'b1;
    end else begin
        W_inter_3_2_write = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if ((~(((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln126_fu_362_p2 == 1'd0))) begin
...
assign In_inter_2_3_din = In_inter_2_2_dout;

assign O_inter_2_2_din = tmp_reg_220;

assign O_temp_6_fu_373_p3 = ((and_ln130_reg_396[0:0] === 1'b1) ? grp_fu_290_p2 : p_0_2_i_i_i_reg_267);

assign W_inter_3_2_din = W_inter_2_2_dout;

assign add_ln207_1_loc_out_din = add_ln207_1_loc_dout;

assign and_ln130_fu_311_p2 = (icmp_ln130_fu_299_p2 & icmp_ln130_6_fu_305_p2);
...
always @ (*) begin
    ap_block_state1 = ((p_k_out_full_n == 1'b0) | (p_chout_out_full_n == 1'b0) | (p_chin_out_full_n == 1'b0) | (p_c_out_full_n == 1'b0) | (1'b0 == add_ln207_1_loc_out_full_n) | (p_r_s_empty_n == 1'b0) | (p_k_s_empty_n == 1'b0) | (p_chout_s_empty_n == 1'b0) | (p_chin_s_empty_n == 1'b0) | (p_c_s_empty_n == 1'b0) | (1'b0 == add_ln207_1_loc_empty_n) | (1'b0 == add_ln207_4_loc_empty_n) | (ap_start == 1'b0) | (p_r_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state3 = ((1'b0 == O_inter_2_2_full_n) & (icmp_ln122_fu_336_p2 == 1'd0));
end

always @ (*) begin
    ap_block_state5 = (((1'b0 == W_inter_3_2_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_3_full_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == In_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)) | ((1'b0 == W_inter_2_2_empty_n) & (icmp_ln126_fu_362_p2 == 1'd0)));
end
...
assign icmp_ln130_6_fu_305_p2 = (($signed(p_chout_s_dout) > $signed(add_ln207_1_loc_dout)) ? 1'b1 : 1'b0);
