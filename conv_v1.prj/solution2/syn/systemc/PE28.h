...
struct PE28 : public sc_module {
    ...
    sc_in< sc_lv<32> > W_inter_1_3_dout;
    sc_in< sc_logic > W_inter_1_3_empty_n;
    sc_out< sc_logic > W_inter_1_3_read;
    sc_in< sc_lv<32> > In_inter_1_3_dout;
    sc_in< sc_logic > In_inter_1_3_empty_n;
    sc_out< sc_logic > In_inter_1_3_read;
    sc_out< sc_lv<32> > W_inter_2_3_din;
    sc_in< sc_logic > W_inter_2_3_full_n;
    sc_out< sc_logic > W_inter_2_3_write;
    sc_out< sc_lv<32> > In_inter_1_4_din;
    sc_in< sc_logic > In_inter_1_4_full_n;
    sc_out< sc_logic > In_inter_1_4_write;
    ...
    sc_out< sc_lv<32> > O_inter_1_3_din;
    sc_in< sc_logic > O_inter_1_3_full_n;
    sc_out< sc_logic > O_inter_1_3_write;
    ...
    Systolic_Array_Cocud<1,4,32,32,32>* Systolic_Array_Cocud_U240;
    Systolic_Array_CodEe<1,2,32,32,32>* Systolic_Array_CodEe_U241;
    ...
    sc_signal< sc_lv<1> > icmp_ln130_9_fu_305_p2;
    ...
    void thread_In_inter_1_3_read();
    void thread_In_inter_1_4_blk_n();
    void thread_In_inter_1_4_din();
    void thread_In_inter_1_4_write();
    void thread_O_inter_1_3_blk_n();
    void thread_O_inter_1_3_din();
    void thread_O_inter_1_3_write();
    void thread_O_temp_9_fu_365_p3();
    void thread_W_inter_1_3_blk_n();
    void thread_W_inter_1_3_read();
    void thread_W_inter_2_3_blk_n();
    void thread_W_inter_2_3_din();
    void thread_W_inter_2_3_write();
    ...
    void thread_icmp_ln130_9_fu_305_p2();
