...
output   ap_idle;
output   ap_ready;
input  [31:0] W_next_V417_dout;
input   W_next_V417_empty_n;
output   W_next_V417_read;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V417_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V417_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V417_empty_n));
end
