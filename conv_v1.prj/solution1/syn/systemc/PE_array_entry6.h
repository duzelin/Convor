...
#ifndef _PE_array_entry6_HH_
#define _PE_array_entry6_HH_
...
struct PE_array_entry6 : public sc_module {
    ...
    // Module declarations
    PE_array_entry6(sc_module_name name);
    SC_HAS_PROCESS(PE_array_entry6);
