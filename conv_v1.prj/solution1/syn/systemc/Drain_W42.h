...
#ifndef _Drain_W42_HH_
#define _Drain_W42_HH_
...
struct Drain_W42 : public sc_module {
    ...
    sc_in< sc_lv<32> > W_next_V416_dout;
    sc_in< sc_logic > W_next_V416_empty_n;
    sc_out< sc_logic > W_next_V416_read;
    ...
    // Module declarations
    Drain_W42(sc_module_name name);
    SC_HAS_PROCESS(Drain_W42);
    ...
    sc_signal< sc_logic > W_next_V416_blk_n;
    ...
    void thread_W_next_V416_blk_n();
    void thread_W_next_V416_read();
