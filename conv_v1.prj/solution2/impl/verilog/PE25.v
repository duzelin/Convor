...
wire   [0:0] icmp_ln130_12_fu_275_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == O_inter_1_0_full_n) & (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (posedge ap_clk) begin
    if ((~((p_r_out_full_n == 1'b0) | (p_k_out_full_n == 1'b0) | (p_chout_out_full_n == 1'b0) | (p_chin_out_full_n == 1'b0) | (p_c_out_full_n == 1'b0) | (cho_out_full_n == 1'b0) | (p_r_s_empty_n == 1'b0) | (p_k_s_empty_n == 1'b0) | (p_chout_s_empty_n == 1'b0) | (p_chin_s_empty_n == 1'b0) | (p_c_s_empty_n == 1'b0) | (cho_empty_n == 1'b0) | (1'b0 == add_ln207_3_loc_empty_n) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign O_inter_1_0_din = tmp_reg_247;

assign O_temp_12_fu_335_p3 = ((and_ln130_reg_357[0:0] === 1'b1) ? grp_fu_260_p2 : tmp_reg_247);
...
assign and_ln130_fu_281_p2 = (icmp_ln130_fu_269_p2 & icmp_ln130_12_fu_275_p2);
...
always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((1'b0 == W_inter_2_0_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_1_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == W_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0))));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((1'b0 == W_inter_2_0_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_1_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == W_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0))));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((1'b0 == W_inter_2_0_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_1_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == W_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0))));
end
...
always @ (*) begin
    ap_block_state1 = ((p_r_out_full_n == 1'b0) | (p_k_out_full_n == 1'b0) | (p_chout_out_full_n == 1'b0) | (p_chin_out_full_n == 1'b0) | (p_c_out_full_n == 1'b0) | (cho_out_full_n == 1'b0) | (p_r_s_empty_n == 1'b0) | (p_k_s_empty_n == 1'b0) | (p_chout_s_empty_n == 1'b0) | (p_chin_s_empty_n == 1'b0) | (p_c_s_empty_n == 1'b0) | (cho_empty_n == 1'b0) | (1'b0 == add_ln207_3_loc_empty_n) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage1_iter0 = (((1'b0 == W_inter_2_0_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_1_full_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == In_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0)) | ((1'b0 == W_inter_1_0_empty_n) & (icmp_ln122_reg_376 == 1'd0)));
end
...
assign icmp_ln130_12_fu_275_p2 = (($signed(p_chout_s_dout) > $signed(cho_dout)) ? 1'b1 : 1'b0);
