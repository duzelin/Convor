...
#ifndef _Drain_In39_HH_
#define _Drain_In39_HH_
...
struct Drain_In39 : public sc_module {
    ...
    sc_in< sc_lv<32> > In_pre_V214_dout;
    sc_in< sc_logic > In_pre_V214_empty_n;
    sc_out< sc_logic > In_pre_V214_read;
    ...
    // Module declarations
    Drain_In39(sc_module_name name);
    SC_HAS_PROCESS(Drain_In39);
    ...
    sc_signal< sc_logic > In_pre_V214_blk_n;
    ...
    void thread_In_pre_V214_blk_n();
    void thread_In_pre_V214_read();
