...
PE23::PE23(sc_module_name name) : sc_module(name), mVcdFile(0) {
    Systolic_Array_CodEe_U125 = new Systolic_Array_CodEe<1,4,32,32,32>("Systolic_Array_CodEe_U125");
    Systolic_Array_CodEe_U125->clk(ap_clk);
    Systolic_Array_CodEe_U125->reset(ap_rst);
    Systolic_Array_CodEe_U125->din0(ap_phi_mux_tmp_phi_fu_312_p4);
    Systolic_Array_CodEe_U125->din1(tmp_4_i_i_i_reg_455);
    Systolic_Array_CodEe_U125->ce(grp_fu_320_ce);
    Systolic_Array_CodEe_U125->dout(grp_fu_320_p2);
    Systolic_Array_CoeOg_U126 = new Systolic_Array_CoeOg<1,2,32,32,32>("Systolic_Array_CoeOg_U126");
    Systolic_Array_CoeOg_U126->clk(ap_clk);
    Systolic_Array_CoeOg_U126->reset(ap_rst);
    Systolic_Array_CoeOg_U126->din0(tmp_63_reg_450);
    Systolic_Array_CoeOg_U126->din1(tmp_64_reg_445);
    Systolic_Array_CoeOg_U126->ce(grp_fu_325_ce);
    Systolic_Array_CoeOg_U126->dout(grp_fu_325_p2);
...
PE23::~PE23() {
    ...
    delete Systolic_Array_CoeOg_U126;
}
