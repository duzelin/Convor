...
#ifndef _Drain_In37_HH_
#define _Drain_In37_HH_
...
struct Drain_In37 : public sc_module {
    ...
    sc_in< sc_lv<32> > In_pre_V4_dout;
    sc_in< sc_logic > In_pre_V4_empty_n;
    sc_out< sc_logic > In_pre_V4_read;
    ...
    // Module declarations
    Drain_In37(sc_module_name name);
    SC_HAS_PROCESS(Drain_In37);
    ...
    sc_signal< sc_logic > In_pre_V4_blk_n;
    ...
    void thread_In_pre_V4_blk_n();
    void thread_In_pre_V4_read();
