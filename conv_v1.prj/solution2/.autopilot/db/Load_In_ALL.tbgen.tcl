...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "41", "Max" : "1839"}
	, {"Name" : "Interval", "Min" : "41", "Max" : "1839"}
]}
...
set Spec2ImplPortList { 
	In_buf { ap_memory {  { In_buf_address0 mem_address 1 9 }  { In_buf_ce0 mem_ce 1 1 }  { In_buf_q0 mem_dout 0 32 }  { In_buf_address1 MemPortADDR2 1 9 }  { In_buf_ce1 MemPortCE2 1 1 }  { In_buf_q1 MemPortDOUT2 0 32 } } }
