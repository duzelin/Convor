...
set C_modelArgList {
	{ Out_buf float 32 regular {array 500 { 1 0 } 1 1 }  }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "801"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "801"}
]}
...
set Spec2ImplPortList { 
	Out_buf { ap_memory {  { Out_buf_address0 mem_address 1 9 }  { Out_buf_ce0 mem_ce 1 1 }  { Out_buf_q0 mem_dout 0 32 }  { Out_buf_address1 MemPortADDR2 1 9 }  { Out_buf_ce1 MemPortCE2 1 1 }  { Out_buf_we1 MemPortWE2 1 1 }  { Out_buf_d1 MemPortDIN2 1 32 } } }
