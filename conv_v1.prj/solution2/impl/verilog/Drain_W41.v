...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V4_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V4_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V4_empty_n));
end
