...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Systolic_Array_Conv_AXILiteS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {Systolic_Array_Conv_gmem_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Systolic_Array_Conv_gmem_m_axi
}
