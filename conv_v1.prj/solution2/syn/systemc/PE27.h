...
struct PE27 : public sc_module {
    ...
    sc_in< sc_lv<32> > W_inter_1_2_dout;
    sc_in< sc_logic > W_inter_1_2_empty_n;
    sc_out< sc_logic > W_inter_1_2_read;
    sc_in< sc_lv<32> > In_inter_1_2_dout;
    sc_in< sc_logic > In_inter_1_2_empty_n;
    sc_out< sc_logic > In_inter_1_2_read;
    sc_out< sc_lv<32> > W_inter_2_2_din;
    sc_in< sc_logic > W_inter_2_2_full_n;
    sc_out< sc_logic > W_inter_2_2_write;
    sc_out< sc_lv<32> > In_inter_1_3_din;
    sc_in< sc_logic > In_inter_1_3_full_n;
    sc_out< sc_logic > In_inter_1_3_write;
    ...
    sc_out< sc_lv<32> > O_inter_1_2_din;
    sc_in< sc_logic > O_inter_1_2_full_n;
    sc_out< sc_logic > O_inter_1_2_write;
    ...
    Systolic_Array_CodEe<1,4,32,32,32>* Systolic_Array_CodEe_U221;
    Systolic_Array_CoeOg<1,2,32,32,32>* Systolic_Array_CoeOg_U222;
    ...
    sc_signal< sc_lv<1> > icmp_ln130_10_fu_275_p2;
    ...
    void thread_In_inter_1_2_read();
    void thread_In_inter_1_3_blk_n();
    void thread_In_inter_1_3_din();
    void thread_In_inter_1_3_write();
    void thread_O_inter_1_2_blk_n();
    void thread_O_inter_1_2_din();
    void thread_O_inter_1_2_write();
    void thread_O_temp_10_fu_335_p3();
    void thread_W_inter_1_2_blk_n();
    void thread_W_inter_1_2_read();
    void thread_W_inter_2_2_blk_n();
    void thread_W_inter_2_2_din();
    void thread_W_inter_2_2_write();
    ...
    void thread_icmp_ln130_10_fu_275_p2();
