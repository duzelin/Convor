...
architecture behav of Read_W_buf is 
    ...
    signal icmp_ln274_reg_148 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_0_rec_reg_93 : STD_LOGIC_VECTOR (30 downto 0);
    signal p_0_rec_reg_93_pp0_iter1_reg : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_state8_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state9_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state10_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln274_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln274_reg_148_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal i_fu_125_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal i_reg_152 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal W_ddr_addr_read_reg_157 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state8 : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_phi_mux_p_0_rec_phi_fu_97_p4 : STD_LOGIC_VECTOR (30 downto 0);
    signal p_0_rec_cast_fu_131_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln273_fu_105_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_0_cast_fu_116_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    p_0_rec_reg_93_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln274_reg_148 = ap_const_lv1_1))) then 
                p_0_rec_reg_93 <= i_reg_152;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state7)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln274_reg_148 = ap_const_lv1_1))) then
                W_ddr_addr_read_reg_157 <= m_axi_W_ddr_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln274_reg_148 <= icmp_ln274_fu_120_p2;
                icmp_ln274_reg_148_pp0_iter1_reg <= icmp_ln274_reg_148;
                p_0_rec_reg_93_pp0_iter1_reg <= p_0_rec_reg_93;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_W_ddr_ARREADY, ap_enable_reg_pp0_iter1, icmp_ln274_fu_120_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((icmp_ln274_fu_120_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)) or ((icmp_ln274_fu_120_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)))) then
    ...
    W_address0 <= p_0_rec_cast_fu_131_p1(9 - 1 downto 0);

    W_ce0_assign_proc : process(ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
    ...
    W_ddr_blk_n_R_assign_proc : process(m_axi_W_ddr_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln274_reg_148)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln274_reg_148 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    W_we0_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln274_reg_148_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln274_reg_148_pp0_iter1_reg = ap_const_lv1_1))) then 
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_W_ddr_RVALID, ap_enable_reg_pp0_iter1, icmp_ln274_reg_148)
    begin
                ap_block_pp0_stage0_11001 <= ((m_axi_W_ddr_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln274_reg_148 = ap_const_lv1_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_W_ddr_RVALID, ap_enable_reg_pp0_iter1, icmp_ln274_reg_148)
    begin
                ap_block_pp0_stage0_subdone <= ((m_axi_W_ddr_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln274_reg_148 = ap_const_lv1_1));
    end process;

        ap_block_state10_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state8_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state9_pp0_stage0_iter1_assign_proc : process(m_axi_W_ddr_RVALID, icmp_ln274_reg_148)
    begin
                ap_block_state9_pp0_stage0_iter1 <= ((m_axi_W_ddr_RVALID = ap_const_logic_0) and (icmp_ln274_reg_148 = ap_const_lv1_1));
    end process;


    ap_condition_pp0_exit_iter0_state8_assign_proc : process(icmp_ln274_fu_120_p2)
    begin
        if ((icmp_ln274_fu_120_p2 = ap_const_lv1_0)) then 
    ...
    ap_phi_mux_p_0_rec_phi_fu_97_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln274_reg_148, p_0_rec_reg_93, i_reg_152)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln274_reg_148 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_phi_mux_p_0_rec_phi_fu_97_p4 <= i_reg_152;
        else 
            ap_phi_mux_p_0_rec_phi_fu_97_p4 <= p_0_rec_reg_93;
        end if; 
    end process;
    ...
    i_0_cast_fu_116_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_phi_mux_p_0_rec_phi_fu_97_p4),32));
    i_fu_125_p2 <= std_logic_vector(unsigned(ap_phi_mux_p_0_rec_phi_fu_97_p4) + unsigned(ap_const_lv31_1));
    icmp_ln274_fu_120_p2 <= "1" when (signed(i_0_cast_fu_116_p1) < signed(length_r)) else "0";
    m_axi_W_ddr_ARADDR <= zext_ln273_fu_105_p1(32 - 1 downto 0);
    ...
    m_axi_W_ddr_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln274_reg_148, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln274_reg_148 = ap_const_lv1_1))) then 
    ...
    p_0_rec_cast_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_0_rec_reg_93_pp0_iter1_reg),64));
    zext_ln273_fu_105_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(W_ddr_offset),64));
end behav;
