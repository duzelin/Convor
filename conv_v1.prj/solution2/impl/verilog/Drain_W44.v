...
output   ap_idle;
output   ap_ready;
input  [31:0] W_next_V418_dout;
input   W_next_V418_empty_n;
output   W_next_V418_read;
...
reg    W_next_V418_blk_n;
wire    ap_CS_fsm_pp0_stage0;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0;
reg   [0:0] icmp_ln164_reg_163;
reg    p_c_s_blk_n;
reg    p_chin_s_blk_n;
reg    p_k_s_blk_n;
...
wire   [0:0] icmp_ln164_fu_127_p2;
wire    ap_block_state4_pp0_stage0_iter0;
reg    ap_block_state5_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [127:0] add_ln164_fu_132_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln164_fu_127_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((icmp_ln164_reg_163 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        W_next_V418_blk_n = W_next_V418_empty_n;
    end else begin
        W_next_V418_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((icmp_ln164_reg_163 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        W_next_V418_read = 1'b1;
    end else begin
        W_next_V418_read = 1'b0;
    end
end

always @ (*) begin
    if ((icmp_ln164_fu_127_p2 == 1'd1)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((icmp_ln164_fu_127_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((icmp_ln164_fu_127_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln164_fu_132_p2 = (indvar_flatten31_reg_82 + 128'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V418_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V418_empty_n) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((icmp_ln164_reg_163 == 1'd0) & (1'b0 == W_next_V418_empty_n));
end
...
assign icmp_ln164_fu_127_p2 = ((indvar_flatten31_reg_82 == bound16_reg_158) ? 1'b1 : 1'b0);
