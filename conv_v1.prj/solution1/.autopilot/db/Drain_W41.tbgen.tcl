...
set C_modelName {Drain_W41}
set C_modelType { void 0 }
set C_modelArgList {
	{ W_next_V4 float 32 regular {fifo 0 volatile }  }
	{ p_c_s int 32 regular {fifo 0}  }
	{ p_chin_s int 32 regular {fifo 0}  }
	{ p_k_s int 32 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "W_next_V4", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ W_next_V4_dout sc_in sc_lv 32 signal 0 } 
	{ W_next_V4_empty_n sc_in sc_logic 1 signal 0 } 
	{ W_next_V4_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "W_next_V4_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "W_next_V4", "role": "dout" }} , 
 	{ "name": "W_next_V4_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "W_next_V4", "role": "empty_n" }} , 
 	{ "name": "W_next_V4_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "W_next_V4", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "W_next_V4", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	W_next_V4 { ap_fifo {  { W_next_V4_dout fifo_data 0 32 }  { W_next_V4_empty_n fifo_status 0 1 }  { W_next_V4_read fifo_update 1 1 } } }
